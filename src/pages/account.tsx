    ...
    <div className="noise min-h-[100dvh] bg-[#e9dfcd]">
      ...
      <main className="mx-auto max-w-[900px] px-5 py-14 lg:px-10 lg:py-20">
        ...
        {user && (
          <>
            <div className="mt-10">
              <p className="mb-3 flex items-center gap-2 text-[11px] font-bold uppercase tracking-[.12em] text-[#476269]"><IdCard className="h-4 w-4 text-[#e58c70]" /> Your Sour Card</p>
              <SourCard fullName={fullName} code={user.sourCardCode} />
              <p className="mt-3 text-[11px] text-[#476269]/80">This is a membership card for the guide, not a payment card. Your code is permanent and unique to your account.</p>
            </div>
            ...
            >
              <p className="font-display text-2xl text-[#183c44]">Profile</p>
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-[.1em] text-[#476269]">Username</label>
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-[.1em] text-[#476269]">Email {user.emailVerified && <span className="text-[#2f7a4d]">· verified</span>}</label>
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-[.1em] text-[#476269]">Sour Card code</label>
                ...
                <div className="sm:col-span-2">
                  <label className="block text-[10px] font-bold uppercase tracking-[.1em] text-[#476269]">Address</label>
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-[.1em] text-[#476269]">Date of birth</label>
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-6 flex items-end justify-between">
        <div>
          <p className="font-mono-custom text-[8px] uppercase tracking-[.15em] text-[#f9f0df]/60">Card holder</p>
          <p className="mt-1 text-sm font-semibold uppercase tracking-[.04em]" data-testid="text-sour-card-name">{fullName}</p>
        </div>
        <p className="font-mono-custom text-[8px] uppercase tracking-[.1em] text-[#f9f0df]/40">Not a payment card</p>
      </div>
    </div>
  );
}
