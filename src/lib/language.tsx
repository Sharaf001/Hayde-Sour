...
const translations = {
  en: {
    ...
    openSearch: 'Open search', closeSearch: 'Close search', exploreTitle: 'Explore by type', bestRatedTitle: 'Best rated in Sour', openNowTitle: 'Open now', noRatingYet: 'No community ratings yet.', noOpenPlaces: 'Nothing looks open right now.', beach: 'Beach',
  ...
  ar: {
    ...
    openSearch: 'فتح البحث', closeSearch: 'إغلاق البحث', exploreTitle: 'استكشف حسب النوع', bestRatedTitle: 'الأعلى تقييما في صور', openNowTitle: 'مفتوح الآن', noRatingYet: 'لا توجد تقييمات مجتمع حتى الآن.', noOpenPlaces: 'لا يبدو أن هناك أماكن مفتوحة الآن.', beach: 'الشاطئ',
  ...
  fr: {
    ...
    openSearch: 'Ouvrir la recherche', closeSearch: 'Fermer la recherche', exploreTitle: 'Explorer par type', bestRatedTitle: 'Les mieux notes a Sour', openNowTitle: 'Ouvert maintenant', noRatingYet: 'Pas encore d\'avis communautaire.', noOpenPlaces: 'Rien ne semble ouvert pour le moment.', beach: 'Plage',
